 ...
 * predio predio = new predio(2, 10, 1); // Criar um prédio com 2 elevadores e
 * 10 andares
 * 
 ...
 * painel.atualizarEstadoElevadores(predio.getEstadoElevador(1),
 * predio.getEstadoElevador(2));
 * 
