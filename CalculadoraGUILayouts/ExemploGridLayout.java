...
public class ExemploGridLayout {
    public ExemploGridLayout() {
     JFrame janela1 = new JFrame("Layout Calculadora Custo Viagem");
     ...
     JTextField caixa1 = new JTextField(40);
     painelV.add(caixa1);
     // adicionar componentes ao painel
      // String textBotoes[]={"+","9","8","7","/","6","5","4","*","3","2","1","-","C","0","="};
        String textBotoes[]={"Distância percorrida (em km):","consumo do transporte (em km/l):","9","8","7","6","5","4","3","2","1","0","="};
   ...
   for (int i = 0; i < textBotoes.length;i++) {
     ...
     //config janela1
     janela1.setBounds(400,400,300,300);
